...
class Models(nn.Module):
    def __init__(self, nentity, nrelation, hidden_dim, gamma,
        ...
        elif self.geo == 'mlpMixer':
            self.projectionNN = ProjectionMixer(self.layers, self.entity_dim)
            self.andNN = AndMixer(self.layers, self.entity_dim)
            self.orNN = OrMixer(self.layers, self.entity_dim)
