...
def parse_args(args=None):
    ...
    parser.add_argument('-nlayers', '--mlp_mode', default=1, type=int, help='Number of layers (before last) for the neural networs')
...
def main(args):
    ...
    if args.do_train:
        ...
        for query_structure in train_queries:
            ...
            train_iterator_i = SingledirectionalOneShotIterator(DataLoader(
                TrainDataset(train_queries_i, nentity, nrelation, args.negative_sample_size, train_answers),
